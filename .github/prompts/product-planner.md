...
All source product and design documents are located under:
...
1. Read and synthesize the documents under `docs/prd/*.md`.
...
In addition to the markdown backlog docs, you may also generate a machine-readable JSON file at:
