 ...
 * variant and size modifiers. Based on the shadcn/ui Button component.
 */
...
export interface ButtonProps
  ...
  /**
   * When true, the component renders its child as the root element
   * instead of a `<button>`, merging props and behavior.
   */
  asChild?: boolean;
}
 ...
 * Use `asChild` to compose with other elements like `<a>` or router `<Link>`.
 */
